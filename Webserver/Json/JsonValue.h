...
public:
	...
	static JsonValue array(std::vector<JsonValue> values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (JsonValue& value : values) result.items().push_back(std::move(value)); return result; }
	static JsonValue array(const std::vector<std::string>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (const std::string& value : values) result.items().push_back(JsonValue::string(value)); return result; }
	static JsonValue array(const std::vector<bool>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (bool value : values) result.items().push_back(JsonValue::boolean(value)); return result; }
	static JsonValue array(const std::vector<double>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (double value : values) result.items().push_back(JsonValue::number(value)); return result; }
	static JsonValue array(const std::vector<float>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (float value : values) result.items().push_back(JsonValue::number(value)); return result; }
	static JsonValue array(const std::vector<int>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (int value : values) result.items().push_back(JsonValue::number(value)); return result; }
	static JsonValue array(const std::vector<unsigned int>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (unsigned int value : values) result.items().push_back(JsonValue::number(value)); return result; }
	static JsonValue array(const std::vector<short>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (short value : values) result.items().push_back(JsonValue::number(value)); return result; }
	static JsonValue array(const std::vector<unsigned short>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (unsigned short value : values) result.items().push_back(JsonValue::number(value)); return result; }
	static JsonValue array(const std::vector<char>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (char value : values) result.items().push_back(JsonValue::number(value)); return result; }
	static JsonValue array(const std::vector<unsigned char>& values) { JsonValue result = JsonValue::array(); result.items().reserve(values.size()); for (unsigned char value : values) result.items().push_back(JsonValue::number(value)); return result; }
